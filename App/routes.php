...
// Router::request(HttpMethod::GET, "/path", [YourController::class, "someMethod"]);
 ...
 Router::request(HttpMethod::POST, "/api/updateEtudiant", [EtudiantController::class, "updateEtudiant"]);
 Router::request(HttpMethod::GET, "/api/deleteEtudiant/*", [EtudiantController::class, "delete"]);
 ...
 Router::request(HttpMethod::GET, "/api/deleteAnnee/*", [AnneeController::class, "delete"]);
 ...
 Router::request(HttpMethod::GET, "/api/deleteSemestre/*", [SemestreController::class, "delete"]);
 ...
 Router::request(HttpMethod::GET, "/api/deleteCompetence/*", [CompetenceController::class, "delete"]);
 ...
 Router::request(HttpMethod::GET, "/api/deleteModule/*", [ModuleController::class, "delete"]);
 ...
 Router::request(HttpMethod::POST, "/api/updateCoefficient", [CoefficientController::class, "updateCoefficient"]);
 Router::request(HttpMethod::GET, "/api/deleteCoefficient/*", [CoefficientController::class, "delete"]);
 ...
 Router::request(HttpMethod::GET, "/api/deleteEtuSemestre/*", [EtuSemestreController::class, "delete"]);
 ...
 Router::request(HttpMethod::GET, "/api/deleteEtuComp/*", [EtuCompController::class, "delete"]);
 ...
 Router::request(HttpMethod::POST, "/api/updateEtuModule", [EtuModuleController::class, "updateEtuModule"]);
 Router::request(HttpMethod::GET, "/api/deleteEtuModule/*", [EtuModuleController::class, "delete"]);
 ...
 Router::request(HttpMethod::GET, "/api/deleteUser/*", [UsersController::class, "delete"]);
 ...
 Router::request(HttpMethod::GET, "/api/deleteAvis/*", [AvisController::class, "delete"]);
